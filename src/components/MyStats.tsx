  ...
  render() {
    ...
    return (
      <div className="my-stats">
        {address
          ? <h3>
              Hello, you provided us with following eth address: {address}
            </h3>
          : <div>
              ...
              <RaisedButton label="Rescan" onTouchTap={refreshLoggedUser} />
        ...
        {ethAmmount !== null &&
          <p className="neumarks">
            You commited <b>{ethAmmount}</b> ETH
          </p>}

        {neumarkAmmount !== null &&
          <p className="neumarks">
            Currently you own <b>{neumarkAmmount}</b> NeuMarks
          </p>}
      </div>
    );
  }
